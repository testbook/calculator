...
const inputAddons = [
    { prefix: "Enter the value of side a", suffix: "" },
    { prefix: "Enter the value of side b", suffix: "" },
    { prefix: "Enter the value of side c", suffix: "" }
];

const resultAddons = [
    { prefix: "Perimeter of Triangle", suffix: "" }
];
...
window.onload = function () {
    switch (calcType) {
        case "perimeter-of-a-triangle-calculator":
            inputGenerator();
            resultBoxGenerator();
            break;
        default:
