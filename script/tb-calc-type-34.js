...
function calculateFun() {
    if (!inputNumberFirst.checkValidity() || !pattern.test(inputNumberFirst.value)) {
        ...
        a = parseFloat(inputNumberFirst.value);
        b = parseFloat(inputNumberSecond.value);

        resultBoxFirst.value = (((b - a)*100)/a).toFixed(3);
        resultBoxSecond.value = b > a ? "Increase" : b < a ? "Decrease" : b === a ? "No Change" : null ;
    }
