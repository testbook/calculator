...
const inputAddons = [
    { prefix: "Enter the length(L)", suffix: "units" },
    { prefix: "Enter the Width(W) =", suffix: "units" }
];

const resultAddons = [
    { prefix: "Area of rectangle", suffix: "units<sup>2</sup>" }
];
...
window.onload = function () {
    switch (calcType) {
        case "area-of-a-rectangle-calculator":
            inputGenerator();
            resultBoxGenerator();
            break;
        default:
