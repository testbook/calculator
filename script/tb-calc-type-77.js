...
const inputAddons = [
    { prefix: "Enter the First Percentage ", suffix: "%" },
    { prefix: "Enter the Second Percentage ", suffix: "%" },
];
...
window.onload = function () {
    switch (calcType) {
        case "adding-percentage-calculator":
            inputGenerator();
            resultBoxGenerator();
            break;
        default:
...
function calculateFun() {
    ...
    if(status === true) {
      ...
      resultBoxFirst.value = inputVars[0] + inputVars[1];
