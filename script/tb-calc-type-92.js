...
const inputAddons = [
    { prefix: "Force (F) ", suffix: "N" },
    { prefix: "Distance or Length (D) ", suffix: "m" },
    { prefix: "Torque (T) ", suffix: "N - m" },
];
...
function calculateFun() {
    ...
    if(status === true) {
        ...
        if(f.toLowerCase() === 'x') {
            resultBoxFirst.value = t / d;
        }else if(d.toLowerCase() === 'x') {
            resultBoxFirst.value = t / f;
        }else if(t.toLowerCase() === 'x') {
            resultBoxFirst.value = f * d;
        }else {
