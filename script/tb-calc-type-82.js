...
const inputAddons = [
    { prefix: `Enter Gauge Pressure (P${"g".sub()}) `, suffix: "p" },
    { prefix: `Enter Atmospheric Pressure (P${"at".sub()}) `, suffix: "p" },
    { prefix: `Enter Absolute Pressure (P${"a".sub()}) `, suffix: "p" },
];
...
window.onload = function () {
    switch (calcType) {
        case "absolute-pressure-calculator":
            inputGenerator();
            resultBoxGenerator();
            break;
        default:
...
function calculateFun() {
    ...
    if(status === true) {
        ...
        let [pg, pat, pa] = inputVars;

        if(pg.toLowerCase() === 'x') {
            resultBoxFirst.value = Number(pa) - Number(pat);
        }else if(pat.toLowerCase() === 'x') {
            resultBoxFirst.value = Number(pa) - Number(pg);
        }else if(pa.toLowerCase() === 'x') {
            resultBoxFirst.value = Number(pg) + Number(pat);
        }else {
