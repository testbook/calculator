...
function calculateFun() {
    if (!inputNumberFirst.checkValidity() || !pattern.test(inputNumberFirst.value)) {
       ...
       a = parseInt(inputNumberFirst.value);
       b = parseInt(inputNumberSecond.value);
       c = parseInt(inputNumberThird.value);

       resultBox.value = Math.pow(b,2) - (4*a*c);
    }
