...
const inputAddons = [
    { prefix: "Scientific Notation 1 ", suffix: "" },
    { prefix: "", suffix: "" },
    { prefix: "Scientific Notation 2 ", suffix: "" },
    { prefix: "", suffix: "" },
];

const resultAddons = [
    { prefix: "Multiplication ", suffix: "" },
];
...
window.onload = function () {
    switch (calcType) {
        case "multiplying-scientific-notation-calculator":
            inputGenerator();
            resultBoxGenerator();
            break;
        default:
...
function calculateFun() {
    ...
    if(status === true) {
        ...
        let [a1, e1, a2, e2] = inputVars;

        let a1a2 = a1 * a2;
        let e1e2 = e1 = e2;

        let res = a1a2 + ' x 10 ^ ' + e1e2;
