...
const inputAddons = [
    { prefix: "Value of length", suffix: "" },
    { prefix: "Value of width", suffix: "" },
    { prefix: "Value of height", suffix: "" },
];

const resultAddons = [
    { prefix: "Surface Area = ", suffix: "" },
];
...
window.onload = function () {
    switch (calcType) {
        case "surface-area-of-a-rectangular-prism-calculator":
            inputGenerator();
            resultBoxGenerator();
            break;
        default:
...
function calculateFun() {
    ...
    if(status === true) {
        ...
        resultBoxFirst.value = 2 * ((l*w) + (l*h) + (w*h));
    }
