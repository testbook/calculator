...
const inputAddons = [
    { prefix: "Enter Hypotenuse of the Triangle ", suffix: "" },
    { prefix: "Enter Base of the Triangle ", suffix: "" },
    { prefix: "Enter Perpendicular of the Triangle ", suffix: "" },
];

const resultAddons = [
    { prefix: "Sinθ ", suffix: "" },
    { prefix: "Cosecθ ", suffix: "" },
    { prefix: "Cosθ ", suffix: "" },
    { prefix: "Secθ ", suffix: "" },
    { prefix: "Tanθ ", suffix: "" },
    { prefix: "Cotθ ", suffix: "" },
...
window.onload = function () {
    switch (calcType) {
        case "trigonometric-ratios-calculator":
            inputGenerator();
            resultBoxGenerator();
            break;
        default:
...
function calculateFun() {
    ...
    if(status === true) {
        ...
        resultBoxFirst.value = sin;
        resultBoxSecond.value = cosec;
        resultBoxThird.value = cos;
        resultBoxFourth.value = sec;
        resultBoxFifth.value = tan;
        resultBoxSixth.value = cot;
